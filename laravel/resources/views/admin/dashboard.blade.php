    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <a href="{{url('admin/jenis_produk')}} " class="nav-link">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
                <a href="{{url('admin/kartu')}} " class="nav-link">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
...
<script>
   var lebel = [@foreach($jenis_kelamin as $jk) '{{$jk->jk}}', @endforeach];
...
var data1 = [@foreach($hitung_harga as $hitung) {{$hitung->harga_jual}}, @endforeach];
