                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @empty($user->foto)
                                <img src="{{ url('admin/img/nophoto.jpg') }}" class="rounded-circle p-1 bg-primary" width="110">
                            @else
                                <img src="{{ asset('storage/fotos/' . $users->foto) }}" class="rounded-circle p-1 bg-primary" width="110">
                            @endempty
